...
app.controller('Data', function($scope, $compile){
	d3.json("app/json/europe.topo.json", function(error, europe) {	
		d3.json("app/json/educationEmployment.json", function(json) {
			d3.json("app/json/population.json",function(json2){
				d3.json("app/json/salary.json",function(json3){
					d3.json("app/json/pibCapita.json",function(json4){
						d3.json("app/json/expenditureEducation.json",function(json5){
							d3.json("app/json/education.json",function(json6){
...
// NUM MUJERES CON ESTUDIOS --> % MUJERES TRABAJANDO CON ESOS ESTUDIOS
// NUM HOMBRES CON ESTUDIOS --> % HOMBRES TRABAJANDO
